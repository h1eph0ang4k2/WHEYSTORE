using MyRepository = wheystore.Administration.Repositories.UserPermissionRepository;
using MyRow = wheystore.Administration.UserPermissionRow;

namespace wheystore.Administration.Endpoints;
